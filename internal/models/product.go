...
type Produk struct {
	...
	Pembuat        *Pengguna      `gorm:"foreignKey:DibuatOleh" json:"pembuat,omitempty"`
	DiupdateOleh   uint           `gorm:"column:diupdate_oleh" json:"diupdate_oleh"`
	Pengupdate     *Pengguna      `gorm:"foreignKey:DiupdateOleh" json:"pengupdate,omitempty"`
